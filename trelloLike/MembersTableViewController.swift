...
//  trelloLike
//
//  Created by Marion  on 03/06/2018.
...
class MembersTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        members = apiManager.getMembersBy(boardId: (selectedBoard?.id)!, withKey: key, andToken: token)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = self.members[indexPath.row].fullName
        
        selectedMember = self.members[indexPath.row]
